...
class Forma extends Component {
    ...
    render() {
        const { onSubmit, closeForm,onVisibleConfidence } = this.props;
        return (
                    ...
                    <Formik
                        ...
                        render={({ errors, touched }) => (
                            <Form action="sendmail.php" method="POST" className="form">
                                ...
                                <span className='description'>Відпрвляючи заявку ви погоджуєтесь з <a href="#!"className='pseudoLink' onClick={onVisibleConfidence}>Політикою кофіденційності</a></span>
                            </Form>
                        )}
                    />
